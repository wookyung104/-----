...
<head>
    ...
    <style>
        ...
        p{
            font-family: 'Montserrat', sans-serif; color: 'navy blue';
        }
        #pairs{
            text-align: center;
        }
...
<body>
    ...
    <!--form tag-->
    <br><br><img src="/login_test/pairs.jpg" alt="pairs" id="img">
    <form action="/login_test/login_query.php" method ="post">
        ...
        <p><b>nickname</b></p><input type="text" name="n_name"></input><br><br><br>
            ...
            <div class="div_center">
                <div id="id">
        <input type ="submit", class="btn btn-warning" value="join" color="#000080">
